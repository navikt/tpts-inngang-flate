...
import { HerKommerDetaljer } from './HerKommerDetaljer';
...
import { Tiltak } from './rader/Tiltak';
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <Header scope="col" colSpan={1}>
                                <FilterButton filters={filters.filter((it) => it.column === 3)}>Tiltak</FilterButton>
                            </Header>
                    ...
                    <Body>
                        {paginatedRows.map((it) => (
                            <tr>
                                ...
                                <Cell>
                                    <Tiltak tiltaksnavn={it.tiltak.navn} oppgavereferanse={it.oppgavereferanse} />
                                </Cell>
                                <Cell>'1. april'</Cell>
                                <Cell>
